...
#
# ****************************************************************************
# Name      : NTC_disable_ssh_userenvironment.py 
...
def ssh_userenvironment():
    ...
    with open("/etc/ssh/sshd_config") as fin:
        if ("PermitUserEnvironment no" in data):
            newline = fin.read().replace('PermitUserEnvironment no', 'PermitUserEnvironment yes')
        else:
    ...
    status=disable_ssh_userenvironment()
...
if __name__ == '__main__':
    ...
    fname = timestr + '_NTC_disable_ssh_userenvironment.log'
